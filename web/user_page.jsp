          ...
          <h2 style="font-size: 22px">for Secure Authorized Record Sharing</h2>
                ...
                <nav>
                    <ul class="sf-menu" id="nav">
                        <li ><a href="HealthRecord.jsp">Create Health Records</a></li>
                        <li ><a href="ViewRecords.jsp">View</a></li>
                        <li ><a href="eupdate.jsp">Update</a></li>
                        <li ><a href="upload.jsp">Upload</a></li>
                        <li><a href="edownload.jsp">Download</a></li>
            ...
            <div id="site_content">
                ...
                <div id="content">
                    <%
                        ...
                        ResultSet rs = st.executeQuery("select * from files where idfiles='" + id + "'");
                        if (rs.next()) {
                            String mail[] = {user.getAttribute("mail").toString()};
                            String msg = "Hello, Secret key for Requested file '" + rs.getString("filename") + "' is " + rs.getString("hashkey") + "";
                            MailUtil ss = new MailUtil();
                            ss.sendMail(mail, mail, "Secret Key", msg);
                        }
                        user.setAttribute("fileid", fileid);
                    %>
                    <center> <h1>Welcome ! <font style="color: tomato"> <%=uname%></font></h1></center>

                    <form action="aupdation.jsp" name="name" method="post" onsubmit="return validation()">
                        Enter Your Token:<br>
