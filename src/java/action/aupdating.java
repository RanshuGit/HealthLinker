 ...
 * @author Dell
 */
public class aupdating extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // int j = st.executeUpdate("update patient_record set share_with='"+share+"', fname='"+fstname+"', lname='"+lname+"', email='"+email+"', gender='"+gender+"', address='"+add+"', city='"+city+"', state='"+state+"', zip='"+zip+"', contact='"+mobile+"', dob='"+dob+"', height='"+height+"', weight='"+weight+"', bmi='"+bmi+"', temp='"+temp+"', bg='"+bg+"', bp='"+bp+"', prate='"+pr+"', rrate='"+rr+"'");
            ...
            if (i != 0) {
                ...
                String msg = "Hello, your file is updated! by '" + uname + "'";
                mm.sendMail(mail1, mail1, "File Updated", msg);
                response.sendRedirect("aupdate.jsp?updated='yes'");
            } else {
